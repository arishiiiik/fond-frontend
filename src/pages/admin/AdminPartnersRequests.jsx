...
function AdminPartnersRequests() {
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: '8px', overflow: 'hidden' }}>
          <thead style={{ background: '#f0f0f0' }}>
            <tr>
              ...
              <th style={{ padding: '12px', textAlign: 'left' }}>Организация</th>
          ...
          <tbody>
            {requests.map(r => (
              <tr key={r.id} style={{ borderBottom: '1px solid #ddd' }}>
                ...
                <td style={{ padding: '12px' }}>{r.organization}</td>
...
export default AdminPartnersRequests